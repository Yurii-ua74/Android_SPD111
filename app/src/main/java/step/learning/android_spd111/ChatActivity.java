...
public class ChatActivity extends AppCompatActivity {
    ...
    private String loadChat() {
        ...
        try(InputStream chatStream = new URL( CHAT_URL ).openStream()) { // звернення до URL
    ...
    private String readString(InputStream stream) throws IOException {   // можна винести в окремий класс
        ByteArrayOutputStream byteBuilder = new ByteArrayOutputStream(); // байтове сховище
        int len;
